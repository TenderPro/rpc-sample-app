...
up: ## Start all used containers
up: CMD=up -d log nats app
up: dc
...
reup: ## Restart containers
reup: CMD=up --force-recreate -d log nats app
reup: dc
